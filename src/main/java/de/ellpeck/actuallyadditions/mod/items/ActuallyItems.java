...
public final class ActuallyItems {
    ...
    public static final RegistryObject<Filler> HANDHELD_FILLER = ITEMS.register("handheld_filler", Filler::new);    public static final RegistryObject<Item> TRAVELERS_SACK = ITEMS.register("travelers_sack", () -> new Sack(false));
